...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MembershipsSignupBody', function() {
      beforeEach(function() {
        instance = new MyOhioAssemblycomPublicApi.MembershipsSignupBody();
      });

      it('should create an instance of MembershipsSignupBody', function() {
        // TODO: update the code to test MembershipsSignupBody
        expect(instance).to.be.a(MyOhioAssemblycomPublicApi.MembershipsSignupBody);
      });
