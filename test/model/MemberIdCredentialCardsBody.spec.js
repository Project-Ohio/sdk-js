...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MemberIdCredentialCardsBody', function() {
      beforeEach(function() {
        instance = new MyOhioAssemblycomPublicApi.MemberIdCredentialCardsBody();
      });

      it('should create an instance of MemberIdCredentialCardsBody', function() {
        // TODO: update the code to test MemberIdCredentialCardsBody
        expect(instance).to.be.a(MyOhioAssemblycomPublicApi.MemberIdCredentialCardsBody);
      });
