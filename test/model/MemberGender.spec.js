...
(function(root, factory) {
  ...
  describe('MemberGender', function() {
    it('should create an instance of MemberGender', function() {
      // uncomment below and update the code to test MemberGender
      //var instance = new MyOhioAssemblyComPublicApi.MemberGender();
      //expect(instance).to.be.a(MyOhioAssemblyComPublicApi.MemberGender);
    });
