...
(function(root, factory) {
  ...
  describe('ShopItemType', function() {
    it('should create an instance of ShopItemType', function() {
      // uncomment below and update the code to test ShopItemType
      //var instance = new MyOhioAssemblyComPublicApi.ShopItemType();
      //expect(instance).to.be.a(MyOhioAssemblyComPublicApi.ShopItemType);
    });
