...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MemberIdProfileBody', function() {
      beforeEach(function() {
        instance = new MyOhioAssemblycomPublicApi.MemberIdProfileBody();
      });

      it('should create an instance of MemberIdProfileBody', function() {
        // TODO: update the code to test MemberIdProfileBody
        expect(instance).to.be.a(MyOhioAssemblycomPublicApi.MemberIdProfileBody);
      });
