...
(function(root, factory) {
  ...
  describe('ResPublicCredentialCard', function() {
    it('should create an instance of ResPublicCredentialCard', function() {
      // uncomment below and update the code to test ResPublicCredentialCard
      //var instance = new MyOhioAssemblyComPublicApi.ResPublicCredentialCard();
    ...
    it('should have the property memberProfile (base name: "memberProfile")', function() {
      // uncomment below and update the code to test the property memberProfile
      //var instance = new MyOhioAssemblyComPublicApi.ResPublicCredentialCard();
      //expect(instance).to.be();
    });

    it('should have the property memberDocs (base name: "memberDocs")', function() {
      // uncomment below and update the code to test the property memberDocs
      //var instance = new MyOhioAssemblyComPublicApi.ResPublicCredentialCard();
      //expect(instance).to.be();
    });
