...
(function(root, factory) {
  ...
  describe('MembershipDocKey', function() {
    it('should create an instance of MembershipDocKey', function() {
      // uncomment below and update the code to test MembershipDocKey
      //var instance = new MyOhioAssemblyComPublicApi.MembershipDocKey();
      //expect(instance).to.be.a(MyOhioAssemblyComPublicApi.MembershipDocKey);
    });
