...
(function(root, factory) {
  ...
  describe('AuthRole', function() {
    it('should create an instance of AuthRole', function() {
      // uncomment below and update the code to test AuthRole
      //var instance = new MyOhioAssemblyComPublicApi.AuthRole();
      //expect(instance).to.be.a(MyOhioAssemblyComPublicApi.AuthRole);
    });
